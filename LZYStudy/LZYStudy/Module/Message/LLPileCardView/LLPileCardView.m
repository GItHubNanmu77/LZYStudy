    ...
    [UIView animateWithDuration:0.3
                     animations: ^{
                         ...
                         if ([self.delegate respondsToSelector:@selector(cards:didRightRemovedItemAtIndex:)]) {
                             [self.delegate cards:self didRightRemovedItemAtIndex:self->_currentIndex];
                         }
    ...
    [UIView animateWithDuration:0.3
                     animations:^{
                         ...
                         if ([self.delegate respondsToSelector:@selector(cards:didLeftRemovedItemAtIndex:)]) {
                             [self.delegate cards:self didLeftRemovedItemAtIndex:self->_currentIndex];
                         }
                         [self cardSwipedAction:card];
                     }];
}
...
- (void)setDataSource:(id<LLPileCardViewDataSource>)dataSource {
